classdef ballbotTorqueToVoltageTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testLqiOutputIsBoundedTorqueIndependentOfWheelSpeed( ...
                testCase)
            p = ballbotParameters;
            estimate = zeros(14, 1);
            ...
            testCase.verifyEqual(outputStopped(1:3), ...
                outputRotating(1:3), AbsTol=1.0e-12);
            testCase.verifyLessThanOrEqual(max(abs(outputStopped(1:3))), ...
                p.wheel.commandTorqueLimit + 1.0e-12);
        end
    end
end
